...
JEND is a high-performance, peer-to-peer file transfer tool written in Go. It allows you to move files securely between computers or your phones without configuring servers or opening ports.
